...
message(STATUS "robot_control: 1 messages, 0 services")

set(MSG_I_FLAGS "-Irobot_control:/home/cyrill/ros-playground/src/robot_control/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cyrill/ros-playground/src/robot_control/msg/WheelSpeeds.msg" NAME_WE)
add_custom_target(_robot_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_control" "/home/cyrill/ros-playground/src/robot_control/msg/WheelSpeeds.msg" ""
)
...
_generate_msg_cpp(robot_control
  "/home/cyrill/ros-playground/src/robot_control/msg/WheelSpeeds.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_control)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_control/.+/__init__.pyc?$"
  )
endif()
